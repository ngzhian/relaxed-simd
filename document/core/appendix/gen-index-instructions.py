...
INSTRUCTIONS = [
    ...
    Instruction(r'\I8X16.\RSWIZZLE', r'\hex{FD}~~\hex{80}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vec-rswizzle', r'exec-vec-rswizzle', r'op-rswizzle'),
    Instruction(r'\I32X4.\RTRUNC\K{\_f32x4\_s}', r'\hex{FD}~~\hex{81}~~\hex{02}', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-rtrunc_s'),
    Instruction(r'\I32X4.\RTRUNC\K{\_f32x4\_u}', r'\hex{FD}~~\hex{82}~~\hex{02}', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-rtrunc_u'),
    Instruction(r'\I32X4.\RTRUNC\K{\_f64x2\_s}', r'\hex{FD}~~\hex{83}~~\hex{02}', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-rtrunc_s'),
    Instruction(r'\I32X4.\RTRUNC\K{\_f64x2\_u}', r'\hex{FD}~~\hex{84}~~\hex{02}', r'[\V128] \to [\V128]', r'valid-vcvtop', r'exec-vcvtop', r'op-rtrunc_u'),
    Instruction(r'\F32X4.\RMADD', r'\hex{FD}~~\hex{85}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-vternop', r'exec-vternop', r'op-frmadd'),
    Instruction(r'\F32X4.\RNMADD', r'\hex{FD}~~\hex{86}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-vternop', r'exec-vternop', r'op-frnmadd'),
    Instruction(r'\F64X2.\RMADD', r'\hex{FD}~~\hex{87}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-vternop', r'exec-vternop', r'op-frmadd'),
    Instruction(r'\F64X2.\RNMADD', r'\hex{FD}~~\hex{88}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-vternop', r'exec-vternop', r'op-frnmadd'),
    Instruction(r'\I8X16.\RLANESELECT', r'\hex{FD}~~\hex{89}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-rlaneselect', r'exec-rlaneselect', r'op-rlaneselect'),
    Instruction(r'\I16X8.\RLANESELECT', r'\hex{FD}~~\hex{8A}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-rlaneselect', r'exec-rlaneselect', r'op-rlaneselect'),
    Instruction(r'\I32X4.\RLANESELECT', r'\hex{FD}~~\hex{8B}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-rlaneselect', r'exec-rlaneselect', r'op-rlaneselect'),
    Instruction(r'\I64X2.\RLANESELECT', r'\hex{FD}~~\hex{8C}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-rlaneselect', r'exec-rlaneselect', r'op-rlaneselect'),
    Instruction(r'\F32X4.\RMIN', r'\hex{FD}~~\hex{8D}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-frmin'),
    Instruction(r'\F32X4.\RMAX', r'\hex{FD}~~\hex{8E}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-frmax'),
    Instruction(r'\F64X2.\RMIN', r'\hex{FD}~~\hex{8F}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-frmin'),
    Instruction(r'\F64X2.\RMAX', r'\hex{FD}~~\hex{90}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-frmax'),
    Instruction(r'\I16X8.\RQ15MULRS', r'\hex{FD}~~\hex{91}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vbinop', r'exec-vbinop', r'op-irq15mulr_s'),
    Instruction(r'\I16X8.\RDOT\K{\_i8x16\_i7x16\_s}', r'\hex{FD}~~\hex{92}~~\hex{02}', r'[\V128~\V128] \to [\V128]', r'valid-vec-rdot', r'exec-vec-rdot', r'op-ridotmul'),
    Instruction(r'\I32X4.\RDOT\K{\_i8x16\_i7x16\_add\_s}', r'\hex{FD}~~\hex{93}~~\hex{02}', r'[\V128~\V128~\V128] \to [\V128]', r'valid-vec-rdot', r'exec-vec-rdot', r'op-ridotmul'),
]
